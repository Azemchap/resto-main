...
export default function LoginPage() {
  return (
    <main className="min-h-[80vh] flex items-center justify-center px-4 py-[60px]">
      <motion.div
        ...
        <Card className="p-8 md:p-12">
          <div className="space-y-6">
            <div className="text-center space-y-2">
              <h1 className="text-[32px] leading-[48px] font-semibold">
                Welcome Back
              </h1>
            ...
            <div className="relative">
              <Separator />
              <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-4 text-sm text-muted">
                Or continue with
              </span>
            </div>
